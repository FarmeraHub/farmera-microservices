...
import { GhnApiResponse, GhnDistrict, GhnProvince, GhnWard } from './dto/request/ghn.request.dto';
...
export class GhnService {
    ...
    /**
      * Chuẩn hóa tên địa điểm đầu vào: loại bỏ tiền tố, chuẩn hóa khoảng trắng, viết hoa chữ cái đầu mỗi từ.
      */
