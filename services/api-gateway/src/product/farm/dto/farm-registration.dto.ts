...
export class FarmRegistrationDto {
  ...
  @ApiPropertyOptional({
    ...
    example: 'We grow organic vegetables and fruits.',
  })
  @IsOptional()
  @IsString()
  description?: string;
  ...
  @ApiPropertyOptional({
    description: 'Tax number (if applicable)',
    example: '1234567890',
  })
  @IsString()
  @IsOptional()
  ...
  @ApiProperty({
    description: 'Ward where the farm is located',
    example: 'Phuc Xa',
  })
  @IsString()
  @IsNotEmpty()
