...
export class DeliveryController {
        ...
        throw new HttpException(
          {
            ...
            message:
              'One or more errors occurred while calculating shipping fee.',
            errors: result,
          },
      ...
      throw new HttpException(
        {
          ...
          message:
            'An unexpected error occurred while calculating shipping fee.',
  ...
  @Get('pick-shift')
  @Public()
  @ApiOperation({ summary: 'Get pick shift information' })
  @ApiResponse({
    status: 200,
    description: 'Pick shift information retrieved successfully.',
  })
  async getPickShift() {
    return await this.deliveryService.getDeliveryPickShift();
  }
}
